...
function ajaxHeart(e) {
  ...
  axios__WEBPACK_IMPORTED_MODULE_0___default().post(this.action).then(function (res) {
    var isHearted = _this.heart.classList.toggle('heart__button--hearted'); //console.log(isHearted);
    ...
    if (isHearted) {
      ...
      }, 2500); //remove it afterwards just in case it gets into the way of clicking other elements
    }
  }).catch(console.error);
}
...
function typeAhead(search) {
  ...
  searchInput.on('input', function () {
    ...
    axios__WEBPACK_IMPORTED_MODULE_0___default().get("/api/search?q=".concat(this.value)).then(function (res) {
      ...
      if (res.data.length) {
        searchResults.innerHTML = dompurify__WEBPACK_IMPORTED_MODULE_1___default().sanitize(searchResultsHTML(res.data)); // to strip out the onload from image in case someone wants to load any JS on ur web

        return;
      }

      searchResults.innerHTML = dompurify__WEBPACK_IMPORTED_MODULE_1___default().sanitize("<div class=\"search__result\">No results for ".concat(_this.value, " found! </div>"));
    }).catch(function (err) {
      console.error(err);
    });
...
(0,_modules_autocomplete__WEBPACK_IMPORTED_MODULE_2__["default"])((0,_modules_bling__WEBPACK_IMPORTED_MODULE_1__.$)('#address'), (0,_modules_bling__WEBPACK_IMPORTED_MODULE_1__.$)('#lng'), (0,_modules_bling__WEBPACK_IMPORTED_MODULE_1__.$)('#lat'));
